...
const programData = [
  { id: 1, name: 'Toddlers', image: '/icons/infant.png', animation: 'animate-wiggle' },
  { id: 2, name: 'Early Preschool', image: '/icons/toddler.png', animation: 'animate-wiggle' },
  { id: 3, name: 'Preschool', image: '/icons/girl-toddler.png', animation: 'animate-wiggle' },
  { id: 4, name: 'Pre-K', image: '/icons/children.png', animation: 'animate-wiggle' },
  { id: 5, name: 'Elementary', image: '/icons/young-child.png', animation: 'animate-wiggle' },
];
...
const ShapeItem: React.FC<ShapeItemProps> = ({ name,  shape, image, animation }) => {
  const shapeStyles: Record<string, string> = {
    circle: 'w-[150px] h-[150px] sm:w-[100px] sm:h-[100px] md:w-[120px] md:h-[120] py-10 bg-transparent flex items-center justify-center ',
  ...
  return (
    ...
    >
      <div className={`${shapeStyles[shape]} rounded-full ${animation} relative`}>
        <Image
          src={image}
          alt={name}
          fill
...
const Collage = () => {
  return (
    <div className="w-full bg-[#f8fbf4] mx-auto  py-40 relative">
      <br />
      <br />
      <h1 className='absolute top-5  w-full text-5xl font-bold text-center text-black p-10  '> 6 months - 12 years</h1>
      <Swiper
        slidesPerView={1}
        spaceBetween={0} 
        pagination={{ clickable: true }}
