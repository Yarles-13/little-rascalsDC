...
const FindUs = () => {
  return (
    ...
    >
      {/* Layout */}
      <div className="grid grid-cols-1 md:grid-cols-2 h-auto md:h-[700px]">
        {/* Left Side - Google Map (Hidden on small screens) */}
        ...
        {/* Right Side - Details */}
        <div className="relative flex flex-col justify-center items-center text-white space-y-8 py-8 md:py-0 px-4 text-center">
          {/* Gradient Overlay */}
          <div className="absolute inset-0 bg-gradient-to-r from-black/50 to-transparent pointer-events-none"></div>
